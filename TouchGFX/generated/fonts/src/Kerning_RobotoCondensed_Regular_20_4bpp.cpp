...
KEEP extern const touchgfx::KerningNode kerning_RobotoCondensed_Regular_20_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE =
{
    ...
    { 0x0054, -1 },  // (First char = [0x0054, T], Second char = [0x0119, eogonek], Kerning dist = -1)
    { 0x0059, -1 },  // (First char = [0x0059, Y], Second char = [0x0119, eogonek], Kerning dist = -1)
    { 0x0054, -1 },  // (First char = [0x0054, T], Second char = [0x017A, zacute], Kerning dist = -1)
