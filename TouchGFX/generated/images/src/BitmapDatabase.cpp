...
extern const unsigned char image_sunrise[]; // BITMAP_SUNRISE_ID = 21, Size: 184x184 pixels
extern const unsigned char image_sunset[]; // BITMAP_SUNSET_ID = 22, Size: 184x184 pixels
extern const unsigned char image_temperature_icon[]; // BITMAP_TEMPERATURE_ICON_ID = 23, Size: 256x256 pixels
extern const unsigned char image_thunder[]; // BITMAP_THUNDER_ID = 24, Size: 112x104 pixels
extern const unsigned char image_visibility[]; // BITMAP_VISIBILITY_ID = 25, Size: 128x128 pixels
extern const unsigned char image_wind_speed[]; // BITMAP_WIND_SPEED_ID = 26, Size: 238x170 pixels
