...
extern const unsigned char image_pageindicator[]; // BITMAP_PAGEINDICATOR_ID = 9, Size: 15x15 pixels
extern const unsigned char image_pageindicator_highlight[]; // BITMAP_PAGEINDICATOR_HIGHLIGHT_ID = 10, Size: 15x15 pixels
extern const unsigned char image_rain[]; // BITMAP_RAIN_ID = 11, Size: 111x103 pixels
extern const unsigned char image_rain_thunder[]; // BITMAP_RAIN_THUNDER_ID = 12, Size: 109x108 pixels
extern const unsigned char image_snow[]; // BITMAP_SNOW_ID = 13, Size: 110x88 pixels
extern const unsigned char image_sun_cloud[]; // BITMAP_SUN_CLOUD_ID = 14, Size: 147x121 pixels
extern const unsigned char image_sun_cloud_haze[]; // BITMAP_SUN_CLOUD_HAZE_ID = 15, Size: 160x115 pixels
extern const unsigned char image_sun_rain[]; // BITMAP_SUN_RAIN_ID = 16, Size: 138x130 pixels
extern const unsigned char image_sun_rain_thunder[]; // BITMAP_SUN_RAIN_THUNDER_ID = 17, Size: 137x150 pixels
extern const unsigned char image_temperature_icon[]; // BITMAP_TEMPERATURE_ICON_ID = 18, Size: 256x256 pixels
extern const unsigned char image_thunder[]; // BITMAP_THUNDER_ID = 19, Size: 112x104 pixels
