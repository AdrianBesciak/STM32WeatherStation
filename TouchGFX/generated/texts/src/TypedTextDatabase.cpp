...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_verdanab_27_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_verdanab_29_4bpp());
        break;
    case 2:
