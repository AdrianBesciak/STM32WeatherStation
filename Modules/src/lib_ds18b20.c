...
#include "../include/ds18b20_task.h"
#include <stdio.h>
#include "ansi.h"
...
void Ds18b20_Init() {
    ...
    if(ret != pdPASS){
        puts(ANSI_FG_RED "[termometers]" ANSI_FG_DEFAULT " failed!");
    }else{
        puts(ANSI_FG_GREEN "[termometers]" ANSI_FG_DEFAULT " task created successfully!");
    }
}
